...
- [ ] **01** `new-project/01-cadrage.md` → l'idée **comprise et reformulée** (aucun fichier écrit à cette étape)
...
- [ ] **04** `new-project/04-arborescence.md` → l'**arborescence des écrans**, ajoutée à `docs/PRD.md`
