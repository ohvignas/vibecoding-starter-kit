...
- `ai-context/` — les fichiers à donner à l'IA (règles officielles, `llms.txt`) + un script pour les télécharger automatiquement. Un projet généré ne reçoit **que les dossiers de sa stack** : une vitrine n'a rien à faire des 4,7 Mo de doc Convex.
