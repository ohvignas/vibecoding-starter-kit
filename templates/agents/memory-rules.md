...
- **Consolider** : lance la consolidation de mémoire (Action hebdomadaire `consolidate-memory`) périodiquement — fusionne les doublons, corrige ou archive les entrées obsolètes (déplace vers `archive.md`, ne supprime pas), garde `index.md` < 50 lignes.
