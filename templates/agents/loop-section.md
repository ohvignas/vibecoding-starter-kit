...
| Test live | **« Règle de vérification »** (ce fichier) + `docs/RUN.md` — navigateur/screenshot web · fenêtre desktop · simulateur mobile, parcours E2E via le sous-agent `test-runner` → verdict par le sous-agent `verificateur` |
