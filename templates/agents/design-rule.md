...
**Pas de `docs/design.md` ?** Ne code pas à l'aveugle : génère-en un **express** avec les 4 skills, ou fais régler le thème sur **[tweakcn.com](https://tweakcn.com)** (shadcn/Tailwind) et intègre l'export CSS ; fais **valider**, puis édite (version complète : `/new-project`, étape `05-design-maquette.md`).
