...
test('renderProjectAgentsMd compose la boucle + @import mémoire, sans BMAD', () => {
  const out = renderProjectAgentsMd({ stack: 'saas', assistant: 'cursor', commandsDir: '.cursor/commands', loopSection: 'BOUCLE-SP', designRule: 'REGLE-DESIGN', subagentsRule: 'REGLE-SUBAGENTS', verifyRule: 'REGLE-VERIF', realityRule: 'REGLE-REALITE', secretsRule: 'REGLE-SECRETS', cssMaquetteRule: 'REGLE-CSS', memoryRules: 'REGLES-MEMOIRE' });
